...
bitcoin-cli -regtest -named createrawtransaction inputs='''[{"txid":"'$txid'","vout":0},{"txid":"'$txid'","vout":1}]''' outputs='''{"2MvLcssW49n9atmksjwg2ZCMsEMsoj3pzUP":0.2}''' replaceable=true